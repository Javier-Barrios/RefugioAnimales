...
from RefAnimal.settings import BASE_DIR
...
def biometrico(request):   
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.imwrite('/Users/Javier Barrios/Desktop/ranimal/RefAnimal/ml/dataset/' +'usuario'+'.'+str(id)+'.'+str(sampleNum)+'.jpg', gray[y:y+h,x:x+w])
...
def trainer(request):
    ...
    #Path of the samples
    path = '/Users/Javier Barrios/Desktop/ranimal/RefAnimal/ml/dataset/'
    ...
    recognizer.save('/Users/Javier Barrios/Desktop/ranimal/RefAnimal/ml/recognizer/trainingData.yml')
    cv2.destroyAllWindows()
    success(request, 'Listo')
...
def detect(request):
    ...
    rec.read('/Users/Javier Barrios/Desktop/ranimal/RefAnimal/ml/recognizer/trainingData.yml')
    getId = 0
    ...
    while(True):
        ...
        if(cv2.waitKey(1) == ord('q')):
            ...
            cam.release()
            cv2.destroyAllWindows()
            return redirect('cuenta/'+str(userId))
